...
export const formKahootBodySchema = z.object({
    ...
    form_description: z.string().min(1, { message: "Form Description is required." }),
...
export type FormKahootUpdateBodySchema = z.infer<typeof formKahootUpdateBodySchema>;
export type FormKahootDeleteQuerySchema = z.infer<typeof formKahootDeleteQuerySchema>;